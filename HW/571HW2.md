...
ใช้การ Hide Delegate โดยให้แต่ละ class ดึงข้อมูลจากใน class ของตัวเองและส่งต่อให้ client ซึ่งเราทำโดยสร้าง method ใน class ต่างๆเพื่อดึงเอาจาก class อื่นและส่งข้อมูลกลับมาให้ class Student
